      ...
      <v-card class="mb-4" variant="tonal">
        ...
        <v-card-text>
          <v-row>
            ...
            <v-col cols="12" md="6">
              <v-text-field v-model="criteria.apellido" label="Apellido" variant="outlined" dense clearable></v-text-field>
            </v-col>
            <v-col cols="12" md="6">
...
import type { ClienteSearchCriteria } from '@/types/cliente';

const props = defineProps<{
  show: boolean;
  modelValue: ClienteSearchCriteria;
}>();
